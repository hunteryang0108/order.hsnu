...
def handle(request):
    if request.method in ('GET', 'HEAD'):
        CONTENT = open('./app/Order/html/content.html', 'r', encoding='UTF-8').read()
        STYLE = open('./app/Order/html/style.html', 'r', encoding='UTF-8').read()
        SCRIPT = open('./app/Order/html/script.html', 'r', encoding='UTF-8').read()
